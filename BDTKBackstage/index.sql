...
CREATE TABLE `login` (
  ...
  `user_head` varchar(80) COMMENT '用户头像的地址',
...
insert  into `login`(`user_id`,`username`,`password`,`user_head`,`reg_time`,`study_num`,`phone`) values (1,'admin','123456','admin.jpg','2147483647',0,'0');
